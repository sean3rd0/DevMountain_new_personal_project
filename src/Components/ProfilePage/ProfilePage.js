                ...
                return (
                    <div className="ProfilePageIndividualPostWrappingDiv">
                        ...
                        <UserDisplay 
                            ...
                            // isFollowing={}
                            profilePic={individualPostObject.profile_pic}
                            firstname={individualPostObject.firstname} 
                            lastname={individualPostObject.lastname}
                            username={individualPostObject.username}
                            personId={individualPostObject.person_id}
                        />
                        </div>
